...
1. **Validación de Funcionalidad:** Diseñar y ejecutar casos de prueba para cada nuevo endpoint utilizando **H2 Database** en memoria para asegurar repetibilidad y limpieza de datos.
